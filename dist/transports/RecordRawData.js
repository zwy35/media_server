...
class RecordRawData {
    constructor(client, stream, details) {
        ...
        client.on("data", (channel, data, packet) => {
            ...
            // console.log('data = ', data);  // data is packet.payload
            console.log("RTP(raw):", "Channel=" + channel, "TYPE=" + packet.payloadType, "ID=" + packet.id, "TS=" + packet.timestamp, "M=" + packet.marker);
