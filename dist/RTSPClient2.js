...
const fs = require("fs");
const rawFile = fs.createWriteStream('rawdata0.data');
...
;
class RTSPClient2 extends events_1.EventEmitter {
    constructor(username, password, udpPort, headers) {
        super();
        this.isConnected = false;
        this._cSeq = 0;
        this._nextFreeInterleavedChannel = 0;
        this._nextFreeUDPPort = udpPort;
    ...
    async connect(url, { keepAlive = true, connection = 'udp' } = { keepAlive: true, connection: 'udp' }) {
        ...
        for (let x = 0; x < media.length; x++) {
            ...
            console.log('DESCRIBE:media-------Begin');
            console.log(mediaSource);
            console.log('DESCRIBE:media-------End');
    ...
    _onData(data) {
        //console.log('_onData:data --------- Begin');
        //console.log(data);
        //console.log('_onData:data --------- End');
        let index = 0;
        // $
        ...
        console.log('_onData:data --------- leave');
    }
